...
/// The authenticated app's bottom-tab shell (docs/07 §2.1): Discover, Explore,
/// Likes, Chats, Profile. Each tab keeps its own navigation stack and state; everything that
...
/// bar.
///
/// The Explore, Likes and Chats tabs reload whenever they're (re)selected.
class MainShell extends ConsumerWidget {
  ...
  static const _likesIndex = 2;
  static const _chatsIndex = 3;

  void _onSelected(WidgetRef ref, int index) {
    if (index == _exploreIndex) {
      ref.read(exploreTabRefreshProvider.notifier).bump();
    }
