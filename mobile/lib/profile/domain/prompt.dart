...
class PromptLibraryItem {
  const PromptLibraryItem({required this.id, required this.prompt, required this.category});

  factory PromptLibraryItem.fromJson(Map<String, dynamic> json) => PromptLibraryItem(
    id: json['id'] as int,
...
class AnsweredPrompt {
  const AnsweredPrompt({required this.promptId, required this.promptText, required this.answer});
